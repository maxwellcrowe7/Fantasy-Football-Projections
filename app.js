...
function renderRankingsView(content, players) {
  ...
  ordered.forEach((p, i) => {
    ...
    const dstBadgeStyle = `background:${teamClr}22;color:${teamClr};border:1px solid ${teamClr}55;border-radius:3px;padding:3px 6px;font-size:10px;font-weight:700;letter-spacing:0.04em;white-space:nowrap;text-align:center;display:inline-block;width:120px;box-sizing:border-box;`;
